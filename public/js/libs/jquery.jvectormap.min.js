 ...
 * @param {Object} params.labels Defines parameters for rendering static labels. Object could contain two keys: <code>regions</code> and <code>markers</code>. Each key value defines configuration.php object with the following possible options:
<ul>
...
jvm.Map.prototype = {
   ...
   * @param This method takes a configuration.php object as the single argument. The options passed to it are the following:
   ...
   * @param {Object} marker Marker configuration.php parameters.
